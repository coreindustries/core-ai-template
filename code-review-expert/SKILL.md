...
✅ **Use this skill when:**
- You want a structured review of uncommitted or staged git changes
- Before merging a PR — catch issues a human reviewer would flag
- After a large refactor to verify no regressions in design quality
- To audit security, performance, and correctness in changed code

❌ **Don't use this skill when:**
- There are no git changes to review (empty diff)
- You want a full codebase audit (this reviews *changes*, not the whole repo)
- You need a style-only review (use a linter instead)
...
**Thoroughness:**
- Load all reference checklists before beginning analysis
- Include file:line references for all findings
- Cross-reference with project conventions and tech stack
